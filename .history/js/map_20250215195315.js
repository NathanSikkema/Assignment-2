...
function updateRouteDropdowns() {
    ...
    allMarkers.forEach(marker => {
        const optionText = marker.title; // Customize the displayed text if needed
    ...
    // Add event listeners to disable matching options
...
function disableMatchingOptions() {
    ...
    // For the origin dropdown, disable the option in destination that matches the origin
    ...
    // For the destination dropdown, disable the option in origin that matches the destination
