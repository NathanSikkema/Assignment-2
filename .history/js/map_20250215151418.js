                    ...
                    const infoWindow = new google.maps.InfoWindow({
                        content: `
                            <div id="info-window-content">
                                <div id="info-window-header" style="display: flex; align-items: center; justify-content: center;">
                                    <img src="${storeData.icon}" alt="${store} - ${locationName}" style="max-width:40px; height:auto; margin-left: 5px;">
                                    <h2 style="margin:0; font-size: 1.2em;">${store} - ${locationName}</h2>
                                </div>
