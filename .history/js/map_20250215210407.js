...
function updateLocationsList() {
    ...
    for (const store in storeGroups) {
        ...
        storeLocations.forEach(location => {
            ...
            listItem.innerHTML = `<strong>${location.name}</strong> <br> <span class="listed-item-address">Address:` + location.isCustom ? `<a href="${location.link}" target="_blank">${location.address}</a></span>`: `${location.address}`;
